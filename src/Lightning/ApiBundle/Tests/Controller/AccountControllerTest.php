...
class AccountControllerTest extends ApiControllerTest
{
    public function testCreate()
    {
        ...
        $this->assertEquals('{"id":1,"url":"http:\/\/localhost\/accounts\/1","short_url":"http:\/\/localhost\/1\/abc","account":"http:\/\/localhost\/accounts\/1?secret=123","lists_url":"http:\/\/localhost\/accounts\/1\/lists"}', $response->getContent());
    ...
    public function testShow()
    {
        ...
        $crawler = $this->client->request('GET', '/accounts/1', array(), array(), array(
            'HTTP_ACCOUNT' => 'http://localhost/accounts/1?secret=123',
            'HTTP_ACCEPT' => 'application/json',
        ));

        $response = $this->client->getResponse();
        $this->assertEquals('{"id":1,"url":"http:\/\/localhost\/accounts\/1","short_url":"http:\/\/localhost\/1\/abc","lists_url":"http:\/\/localhost\/accounts\/1\/lists"}', $response->getContent());
        $this->assertEquals('application/json', $response->headers->get('Content-Type'));
    ...
    public function testShowWrongId()
    {
        ...
        $crawler = $this->client->request('GET', '/accounts/999', array(), array(), array(
            'HTTP_ACCOUNT' => 'http://localhost/accounts/1?secret=123',
            'HTTP_ACCEPT' => 'application/json',
        ));
    ...
    public function testShowWrongAccount()
    {
        ...
        $crawler = $this->client->request('GET', '/accounts/2', array(), array(), array(
            'HTTP_ACCOUNT' => 'http://localhost/accounts/1?secret=123',
            'HTTP_ACCEPT' => 'application/json',
        ));
    ...
    public function testDeviceToken()
    {
        ...
        $crawler = $this->client->request('PUT', '/accounts/1/device_tokens/ABC123', array(), array(), array(
            'HTTP_ACCOUNT' => 'http://localhost/accounts/1?secret=123',
            'HTTP_ACCEPT' => 'application/json',
        ));
    ...
    public function testDeviceTokenException()
    {
        ...
        $response = $this->client->getResponse();
        $this->assertEquals('{"error":{"code":500,"message":"Internal error"}}', trim($response->getContent()));
        $this->assertEquals('application/json', $response->headers->get('Content-Type'));
    ...
    public function testDeviceTokenWrongId()
    {
        ...
        $crawler = $this->client->request('PUT', '/accounts/999/device_tokens/ABC123', array(), array(), array(
            'HTTP_ACCOUNT' => 'http://localhost/accounts/1?secret=123',
            'HTTP_ACCEPT' => 'application/json',
        ));
    ...
    public function testDeviceTokenWrongAccount()
    {
        ...
        $crawler = $this->client->request('PUT', '/accounts/2/device_tokens/ABC123', array(), array(), array(
            'HTTP_ACCOUNT' => 'http://localhost/accounts/1?secret=123',
            'HTTP_ACCEPT' => 'application/json',
        ));
